...
namespace OnyxScoutApplication.Server.Migrations
{
    ...
    [Migration("20210420163202_customEvents")]
    partial class customEvents
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("OnyxScoutApplication.Shared.Models.CustomAlliance", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("OnyxScoutApplication.Shared.Models.CustomAlliances", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("OnyxScoutApplication.Shared.Models.CustomEvent", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("OnyxScoutApplication.Shared.Models.CustomMatch", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("OnyxScoutApplication.Shared.Models.CustomTeam", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("OnyxScoutApplication.Shared.Models.CustomAlliances", b =>
                {
                    b.HasOne("OnyxScoutApplication.Shared.Models.CustomAlliance", "Blue")
                        .WithMany()
                        .HasForeignKey("BlueId");

                    b.HasOne("OnyxScoutApplication.Shared.Models.CustomAlliance", "Red")
                        .WithMany()
                        .HasForeignKey("RedId");
                });
            ...
            modelBuilder.Entity("OnyxScoutApplication.Shared.Models.CustomMatch", b =>
                {
                    b.HasOne("OnyxScoutApplication.Shared.Models.CustomAlliances", "Alliances")
                        .WithMany()
                        .HasForeignKey("AlliancesId");

                    b.HasOne("OnyxScoutApplication.Shared.Models.CustomEvent", "Event")
                        .WithMany("Matches")
            ...
            modelBuilder.Entity("OnyxScoutApplication.Shared.Models.CustomTeam", b =>
                {
                    b.HasOne("OnyxScoutApplication.Shared.Models.CustomAlliance", null)
                        .WithMany("TeamKeys")
